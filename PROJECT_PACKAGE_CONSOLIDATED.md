...
截至 2026-09-04，T5R0、T5R1 和 T5R2 已完成；由于 SNGAR 外部访问仍不可用，已固定 IDSSE 暂代 T5R1–T5R4 的开发数据角色。IDSSE 来源登记、raw SHA-256、canonical conversion、逐场 QC、match-level split 和 T5R2 task/baseline/metric lock 已完成，但尚未训练模型。
