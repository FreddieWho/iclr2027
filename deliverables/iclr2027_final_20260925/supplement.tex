\hypertarget{supplementary-methods-and-results}{%
\section{Supplementary Methods and Results}\label{supplementary-methods-and-results}}

\hypertarget{task-oracle-and-eligible-quartets}{%
\subsection{Task, oracle, and eligible quartets}\label{task-oracle-and-eligible-quartets}}
...
\hypertarget{coordinate-models-splits-and-repair-flow-protocol}{%
\subsection{Coordinate models, splits, and repair-flow protocol}\label{coordinate-models-splits-and-repair-flow-protocol}}
...
Hard baseline \(H\)\strut
\end{minipage} & \begin{minipage}[b]{0.14\columnwidth}\raggedleft
Full repair\strut
\end{minipage} & \begin{minipage}[b]{0.14\columnwidth}\raggedleft
Migration\strut
\end{minipage} & \begin{minipage}[b]{0.14\columnwidth}\raggedleft
Endpoint repair\strut
\end{minipage} & \begin{minipage}[b]{0.14\columnwidth}\raggedleft
Migration / endpoint repair\strut
...
\hypertarget{geometry-by-supervision-comparison}{%
\subsection{Geometry-by-supervision comparison}\label{geometry-by-supervision-comparison}}
...
\toprule
Representation & Supervision & Mean \(J_3\) & Full repair range & Relocation range\tabularnewline
\midrule
\endhead
Coordinates & Clean & 0.053 & --- & ---\tabularnewline
Coordinates & Change-augmented & 0.068 & 0.025--0.100 & 0.364--0.400\tabularnewline
Geometry & Clean & 0.170 & 0.136--0.233 & 0.167--0.255\tabularnewline
Geometry & Change-augmented & 0.401 & 0.364--0.442 & 0.317--0.418\tabularnewline
\bottomrule
\end{longtable}
...
\hypertarget{rendered-image-screen}{%
\subsection{Rendered-image screen}\label{rendered-image-screen}}
...
\toprule
Seed & Baseline failures & Full repairs & Relocations & Endpoint repairs\tabularnewline
\midrule
\endhead
803 & 16 & 10 & 1 & 11\tabularnewline
805 & 12 & 9 & 1 & 10\tabularnewline
806 & 12 & 5 & 3 & 8\tabularnewline
\bottomrule
\end{longtable}
...
\hypertarget{per-seed-uncertainty-for-coordinate-repair}{%
\subsection{Per-seed uncertainty for coordinate repair}\label{per-seed-uncertainty-for-coordinate-repair}}
...
\toprule
Seed & Full repair & Relocation & Endpoint repair\tabularnewline
\midrule
\endhead
11 & 0.0636 {[}0.0189, 0.1262{]} & 0.3636 {[}0.2365, 0.5096{]} & 0.4273 {[}0.2991, 0.5785{]}\tabularnewline
23 & 0.0250 {[}0.0000, 0.0574{]} & 0.4000 {[}0.2645, 0.5385{]} & 0.4250 {[}0.2913, 0.5684{]}\tabularnewline
47 & 0.1000 {[}0.0348, 0.1837{]} & 0.3818 {[}0.2362, 0.5313{]} & 0.4818 {[}0.3333, 0.6372{]}\tabularnewline
\bottomrule
\end{longtable}

\hypertarget{reporting-and-reproducibility}{%
\subsection{Reporting and reproducibility}\label{reporting-and-reproducibility}}
