...
| U02 coverage | refusal 0.43->0.118 (lexico, 93 oracle-feasible scenes of 171) | 93 | coord | dev/test | s11 | discovery | u02 result.json + U02.md | feasible-set coverage | non-refusal precision gain |
