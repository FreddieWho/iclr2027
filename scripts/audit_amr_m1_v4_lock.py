#!/usr/bin/env python3
"""Audit the P4 AMR v4 design lock (research-driven redesign).
...
(pre-training gate; closed runs m1_v1/v2/v3 are acknowledged history).
"""
...
LOCK = P4 / "m1_v4_config_lock.json"
FAILURES: list[str] = []
...
def main() -> int:
    ...
    check(lock["lock_id"] == "amr_m1_v4_config_lock", "lock id")
