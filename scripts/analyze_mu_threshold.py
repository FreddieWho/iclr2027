...
def main() -> int:
    ...
    T5R3 = load_module(ROOT / "scripts" / "run_t5r3_sanity.py", "t5r3_mu")
    T5R5 = load_module(ROOT / "scripts" / "run_t5r5_hidden_confirmation.py", "t5r5_mu")
    FC = load_module(ROOT / "scripts" / "p2_fracture_controls.py", "fc_mu")
    sweep = load_module(ROOT / "scripts" / "run_p3_epsilon_sweep.py", "sweep_mu")
    sweep.EPSILONS = (0.25,)
    sweep.N_SNAPSHOTS = N_SETS
    v4 = load_module(ROOT / "scripts" / "amr_model_v4.py", "v4_mu")
    v5mod = load_module(ROOT / "scripts" / "amr_model_v5.py", "v5_mu")
    v5capmod = load_module(ROOT / "scripts" / "amr_model_v5cap.py", "v5cap_mu")
