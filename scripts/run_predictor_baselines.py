...
def main() -> int:
    ...
    T5R3 = load_module(ROOT / "scripts" / "run_t5r3_sanity.py", "t5r3_for_baselines")
    T5R5 = load_module(ROOT / "scripts" / "run_t5r5_hidden_confirmation.py", "t5r5_for_baselines")
    FC = load_module(ROOT / "scripts" / "p2_fracture_controls.py", "fc_for_baselines")
    sweep = load_module(ROOT / "scripts" / "run_p3_epsilon_sweep.py", "sweep_for_baselines")
    sweep.EPSILONS = (EPS,)
