...
T5R3_PATH = ROOT / "scripts" / "p3_t5r" / "run_t5r3_sanity.py"
T5R5_PATH = ROOT / "scripts" / "p3_t5r" / "run_t5r5_hidden_confirmation.py"
...
def main() -> int:
    ...
    FC = load_module(ROOT / "scripts" / "p2" / "p2_fracture_controls.py", "p2_fracture_controls_for_t5r6")
