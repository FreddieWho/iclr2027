...
def main() -> int:
    ...
    T5R3 = load_module(ROOT / "scripts" / "p3_t5r" / "run_t5r3_sanity.py", "t5r3_for_support_scaling")
    T5R5 = load_module(ROOT / "scripts" / "p3_t5r" / "run_t5r5_hidden_confirmation.py", "t5r5_for_support_scaling")
    FC = load_module(ROOT / "scripts" / "p2" / "p2_fracture_controls.py", "fc_for_support_scaling")
    sweep = load_module(ROOT / "scripts" / "p3_t5r" / "run_p3_epsilon_sweep.py", "eps_sweep_for_support_scaling")
    sweep.EPSILONS = (0.25,)
