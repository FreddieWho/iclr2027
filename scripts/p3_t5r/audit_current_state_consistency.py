...
def main() -> int:
    ...
    required_paths = [
        ...
        "scripts/p3_t5r/audit_idsse_t5r2.py",
        ...
        "scripts/p3_t5r/audit_t5r3_sanity.py",
        "artifacts/phase3/task_semantic_repair_v1/t5r3_sanity_v3/manifest.json",
        "configs/t5r4_round1.yaml",
        "scripts/p3_t5r/run_t5r4_round1.py",
        "scripts/p3_t5r/audit_t5r4_round1.py",
        ...
        "scripts/p3_t5r/run_t5r4_round2.py",
        "scripts/p3_t5r/audit_t5r4_round2.py",
        ...
        "scripts/p3_t5r/compute_t5r5_prelock_audit.py",
        ...
        "scripts/p3_t5r/audit_t5r5_candidate_lock.py",
        "scripts/p3_t5r/run_t5r5_hidden_confirmation.py",
        "scripts/p3_t5r/audit_t5r5_hidden_confirmation.py",
        ...
        "scripts/p3_t5r/download_soccertrack_v2.py",
        "scripts/p3_t5r/prepare_soccertrack_t5r6.py",
        "scripts/p3_t5r/run_t5r6_external_confirmation.py",
        "scripts/p3_t5r/audit_t5r6_confirmation.py",
    ...
    print("- t5r5_status=PASS_STRONG_T5R6_PENDING")
