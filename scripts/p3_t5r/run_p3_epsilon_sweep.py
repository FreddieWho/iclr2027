...
def main() -> int:
    ...
    T5R3 = load_module(ROOT / "scripts" / "p3_t5r" / "run_t5r3_sanity.py", "t5r3_for_eps_sweep")
    T5R5 = load_module(ROOT / "scripts" / "p3_t5r" / "run_t5r5_hidden_confirmation.py", "t5r5_for_eps_sweep")
    FC = load_module(ROOT / "scripts" / "p2" / "p2_fracture_controls.py", "fc_for_eps_sweep")
